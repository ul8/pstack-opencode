...
At the end of the run, before handing back, check the log told the truth. Read this run's OpenCode session under `$XDG_DATA_HOME/opencode` or `~/.local/share/opencode`. Scope to this workspace. Walk the log against what actually happened:
