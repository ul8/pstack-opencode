...
OpenCode session data lives under `$XDG_DATA_HOME/opencode` or `~/.local/share/opencode` (including `opencode.db`). Scope to this workspace. Do not glob other projects.
